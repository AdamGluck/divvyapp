...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [self setTitleForRow:(NSUInteger)indexPath.row];
    cell.detailTextLabel.text = [self setDetailForRow:(NSUInteger)indexPath.row];
    
    return cell;
}

/*
 * This method is ABSTRACT, should be implemented by child class.
 */
